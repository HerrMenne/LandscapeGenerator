...
public class MapGenerator : MonoBehaviour {
    ...
    public void DrawMapInEditor()
    {
        ...
        if (drawMode == DrawMode.NoiseMap)
            ...
            display.DrawMesh(MeshGenerator.GenerateTerrainMesh(mapData.heightMap, meshHeightMultiplier, meshHeightCurve,
                editorLevelOfDetail), TextureCreator.TextureFromColorMap(mapData.colorMap, mapChunkSize, mapChunkSize));
    ...
    MapData GenerateMapData(Vector2 center)
    {
        float[,] noiseMap = Noise.GenerateNoiseMap(mapChunkSize, mapChunkSize, seed,
            noiseScale, octaves, persistance, lacunarity, center + offset);
